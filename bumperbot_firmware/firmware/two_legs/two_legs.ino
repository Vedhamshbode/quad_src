...
void loop() {
  ...
  if(Serial.available()>0){
   ...
   if (msg[0] == 'm' && msg[1] == 'o'){
    ...
    pwm.setPWM(SERVO_10,0,val(th10));
    pwm.setPWM(SERVO_11,0,val(th11));
    ...
    pwm.setPWM(SERVO_3,0,val(th3));
    pwm.setPWM(SERVO_4,0,val2(th4));
    pwm.setPWM(SERVO_5,0,val(th5)+20);

    pwm.setPWM(SERVO_0,0,val(th0)-20);
    pwm.setPWM(SERVO_1,0,val(th1)+25);
    pwm.setPWM(SERVO_2,0,val(th2)+30);
